...
const translations = {
  en: {
    ...
    about_int_text: '<li>Our Consultants have delivered throught their career enterprise programs for Swiss Life, Toll Collect, Evergreen, Carl Zeiss, Helvetia and Hugo Boss while engaged through global advisory organizations. Scope included ERP migrations from on-premises to cloud, application packaging and standardization, and DevOps services—including application and repository migrations to GitHub.</li><li>Supported large-scale infrastructure and operations initiatives for Wintershall, Novozymes and Thales.</li>',
